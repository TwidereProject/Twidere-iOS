...
Twidere for iOS is licensed under GNU General Public License, version 3. Each sub modules may have different license, see `LICENSE` file respectively.

Please remind that since Twidere for iOS is a project licensed under GPL, you cannot publish it to App Store.
