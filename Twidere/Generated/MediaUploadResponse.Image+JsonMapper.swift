...
internal class MediaUploadResponseImageJsonMapper: JsonMapper<MediaUploadResponse.Image> {
    ...
    override func parse(_ parser: PMJacksonParser) -> MediaUploadResponse.Image! {
    ...
    override func parseField(_ instance: MediaUploadResponse.Image, _ fieldName: String, _ parser: PMJacksonParser) {
        switch fieldName {
        default:
            break
        }
