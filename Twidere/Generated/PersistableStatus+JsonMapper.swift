...
internal class PersistableStatusJsonMapper: JsonMapper<PersistableStatus> {

    internal static let singleton = PersistableStatusJsonMapper()

    override func parse(_ parser: PMJacksonParser) -> PersistableStatus! {
    ...
    override func parseField(_ instance: PersistableStatus, _ fieldName: String, _ parser: PMJacksonParser) {
        switch fieldName {
        case "id":
