...
extension String {
    ...
    func decodeHTMLEntitiesWithOffset(_ offsetHandler: ((_ index: String.Index, _ utf16Offset: String.IndexDistance) -> Void)? = nil) -> String {
        ...
        func decode(_ entity : String) -> Character? {
            if entity.hasPrefix("&#x") || entity.hasPrefix("&#X"){
                ...
                return String.characterEntities[entity]
            }
        }
        // ===== Method starts here =====
        var result = ""
        ...
        while let ampRange = self.range(of: "&", range: position ..< endIndex) {
            ...
            if let semiRange = self.range(of: ";", range: position ..< endIndex) {
                ...
                if let decoded = decode(entity) {
                    ...
                    // Record offset
                    offsetHandler?(semiRange.upperBound, 1 - entity.utf16.count)
                } else {
